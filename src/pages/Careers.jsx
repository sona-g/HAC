...
const Careers = () => {
    return (
        ...
        <div className="container p-5">
            ...
            <p>If you have the relevant expereince and the passion to be part of our team, please feel free to drop an email to us at <Link to="/contact" style={{textDecoration: "none"}}><span className="text-primary">contact@hacconsulting.com</span></Link></p>
        </div>
        </div>
        </div>
        </>
